...
namespace Valve.VR.InteractionSystem
{
	...
	public class Player : MonoBehaviour
	{
		...
		public Transform trackingOriginTransform;   //player's transform

		[Tooltip( "List of possible transforms for the head/HMD, including the no-SteamVR fallback camera." )]
		public Transform[] hmdTransforms;   //approximately position of the body (estimated by VR camera or FallbackObjects)    Fallback means the VR doesn't work
		...
		//-------------------------------------------------
		private void ActivateRig( GameObject rig )//make the followHead attach to the VRcamera (headset Online) or Fallback (headset Offline)
		{
